...
function SignIn() {
  ...
  const handleSignIn = () => {
    const stringifieldSignOut = JSON.stringify(false)
    localStorage.setItem('sign-out', stringifieldSignOut)
  ...
  const createAnAccount =  () => {
    ...
    const stringifieldAccount = JSON.stringify(data)
    localStorage.setItem('account', stringifieldAccount)
